...
date : 28/04/2017
Programme ParserPDB : Parse un fichier PDB pour recuperer des données.
Comprend aussi une fonction d'affichage pour verifier le contenue recuperé. """
...
def Affichage(resultats):
	""" cette fonction affiche le contenus d'un dictionnaire de 4 profondeur """
	cmpt=0
